...
var frozenRoutes = []string{
	...
	"GET /api/community/admin/appeals",
	"GET /api/community/admin/notifications/outbox",
	"GET /api/community/admin/reports",
	"GET /api/community/admin/reports/:id",
	...
	"POST /api/community/admin/notifications/outbox/retry",
	"POST /api/community/admin/reports/:id/accept",
	"POST /api/community/admin/reports/:id/reject",
	"POST /api/community/admin/reports/:id/resolve",
	"POST /api/community/entities/:id/posts",
	"POST /api/community/reports",
	"POST /api/community/reports/:id/appeal",
