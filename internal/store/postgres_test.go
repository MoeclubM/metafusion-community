...
func TestSchemaTopicsAndFavoritesAgainstPostgres(t *testing.T) {
	...
	if _, err = db.ExecContext(ctx, `INSERT INTO community.boards(code,names) VALUES('qa','{}'::jsonb) ON CONFLICT (code) DO NOTHING`); err != nil {
		t.Fatalf("seed board: %v", err)
	}

	const topicID = "11111111-1111-1111-1111-111111111111"
	const authorID = "22222222-2222-2222-2222-222222222222"
	_, _ = db.ExecContext(ctx, "DELETE FROM community.topics WHERE id=$1", topicID)
	if _, err = db.ExecContext(ctx, `INSERT INTO community.topics(id,board_code,author_id,title,body)
		VALUES($1,'qa',$2,'t','b')`, topicID, authorID); err != nil {
		t.Fatalf("insert topic: %v", err)
	}
	if _, err = db.ExecContext(ctx, "INSERT INTO community.posts(id,topic_id,author_id,body,post_number) VALUES('33333333-3333-3333-3333-333333333333',$1,$2,'p1',1)", topicID, authorID); err != nil {
